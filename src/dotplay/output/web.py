...
#grid-sizes button.selected { border-color: #8badff; background: #3d4e7d; }
...
<div class="row" id="grid-sizes"><button data-action="grid_size_8" data-grid-size="8">8×8</button><button data-action="grid_size_16" data-grid-size="16">16×16</button><button data-action="grid_size_32" data-grid-size="32">32×32</button></div>
</div>
<div id="help"><div id="help-box"><div id="help-lines"></div><div class="row"><button data-action="escape">Esc</button></div></div></div>
<script>
const canvas = document.querySelector('#grid'), ctx = canvas.getContext('2d'), menu = document.querySelector('#menu'), help = document.querySelector('#help'), helpLines = document.querySelector('#help-lines'), gridSizeButtons = document.querySelectorAll('[data-grid-size]');
